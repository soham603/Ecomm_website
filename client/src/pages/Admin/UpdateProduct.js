...
const UpdateProduct = () => {
    ...
    const getSingleProduct = async () => {
        try {
            const { data } = await axios.get(`/api/v1/products/get-singleproduct/${params.slug}`);
    ...
    const handleCreateProduct = async(e) => {
      ...
      try {
        ...
        const { data } = axios.put(`/api/v1/products/update-product/${id}`, productData);
        ...
        <div className="row">
          ...
          <div className="col-md-9">
            ...
            <div className="m-1 w-75">
              ...
              <div className="mb-3">
                {photo ? (
                  <div className="text-center">
                    ...
                    <div className="text-center">
                        <img src={`/api/v1/products/get-product-photo/${id}`} alt="Product Image" height={'200px'} className="img img-responsive"/>
                    </div>
                  )}
              </div>
              <div className="mb-3">
              ...
              <div className="mb-3">
                <input type="number" value={quantity} placeholder="Enter Quantity of Product" className="form-control" onChange={(e) => setQuantity(e.target.value)}/>
              </div>
